    ...
    <Wrapper>
      <div style={{ background: "#171a29", padding: "30px 20px" }}>
        ...
        <Slider {...settings}>
            <div className="col">
              <Img
                src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_520,h_520/rng/md/carousel/production/ea7ec5oifpixfe6scunp"
                alt="promotion img"
              />
            </div>
            <div className="col">
              <Img
                src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_520,h_520/rng/md/carousel/production/ouuyembnga46m5570ntf"
                alt="promotion img"
              />
            </div>
            <div className="col">
              <Img
                src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_520,h_520/rng/md/carousel/production/yk9xiowlal9om0fd4tnh"
                alt="promotion img"
              />
            </div>
            <div className="col">
              <Img
                src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_520,h_520/rng/md/carousel/production/opby9ba8yaqmrwj2z672"
                alt="promotion img"
              />
            </div>
            <div className="col">
              <Img
                src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_520,h_520/marketing-dashboard/carousel/v3wij0yymhoyanqsyd2a"
              />
            </div>
            <div className="col">
              <Img
